...
In light of the security failure of Rainbow 6:Seige of Ubisoft in late December of 2025, I created a very rudimentary and barebones dataset of "game admins". It has 5 admin entities, whose actions are logged over a period of 30 days.

I injected some "suspicious" behabvior into the logs. Extracted features from this generated dataset, implemented unsupervised learning to identify the suspect via an isolation forest. Created a simple dashboard visualizing the results.
